...
module.exports = function (defaultFuncs, api, ctx) {
  return function getThreadList(limit, timestamp, tags, callback) {
    ...
    const tryFetch = (docId) => {
      ...
      if (timestamp) queryParams.before = timestamp;
      ...
      return defaultFuncs
        ...
        .then((resData) => {
          ...
          return formatThreadList(nodes);
        });
    };

    // Try doc_ids in order, fall back if one fails
    tryFetch("3426149104143726")
      .catch(() => tryFetch("6560856430626295"))
      .catch(() => tryFetch("3336396659757871"))
