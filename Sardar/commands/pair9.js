...
const templateUrl = "https://i.ibb.co/B219yR5b/c2bf57f0bfcf.jpg";
...
module.exports = {
  config: {
    credits: "SARDAR RDX",
    name: "pair9",
    aliases: ["couple9", "goldenpair"],
    description: "Golden Love pair image banao — Circle style (Style 9).",
    usage: "pair9 [@mention / reply]",
    category: "Love",
    prefix: true,
    cooldowns: 5
  },
...
` +
    ...
    const { msgID: loadMsgID, done: animDone } = await animateProgress(api, threadID, messageID, '💛', '𝐆𝐨𝐥𝐝𝐞𝐧 𝐋𝐨𝐯𝐞', 'pair9');
