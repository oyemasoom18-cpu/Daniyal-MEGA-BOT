...
const templateUrl = "https://i.ibb.co/35kTZZrq/d9b029dbb32f.jpg";
...
module.exports = {
  config: {
    ...
    name: "pair4",
    aliases: ["couple4"],
    description: "Romantic pair image banao (Style 4).",
    usage: "pair4 [@mention / reply]",
    category: "Love",
    prefix: true,
    cooldowns: 5
  },
...
` +
    ...
    const { msgID: loadMsgID, done: animDone } = await animateProgress(api, threadID, messageID, '💞', '𝐏𝐚𝐢𝐫', 'pair4');
