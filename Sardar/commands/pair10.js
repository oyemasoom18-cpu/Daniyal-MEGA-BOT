...
const templateUrl = "https://i.ibb.co/PGyRsmDt/aef3796d0e15.jpg";
...
module.exports = {
  config: {
    credits: "SARDAR RDX",
    name: "pair10",
    aliases: ["couple10", "purplepair"],
    description: "Purple Love pair image banao — Circle style (Style 10).",
    usage: "pair10 [@mention / reply]",
    category: "Love",
    prefix: true,
    cooldowns: 5
  },
...
` +
    ...
    const { msgID: loadMsgID, done: animDone } = await animateProgress(api, threadID, messageID, '💜', '𝐏𝐮𝐫𝐩𝐥𝐞 𝐋𝐨𝐯𝐞', 'pair10');
