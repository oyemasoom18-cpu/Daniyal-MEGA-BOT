...
const templateUrl = "https://i.ibb.co/7NGZWC7t/c169c4ea6830.jpg";
...
module.exports = {
  config: {
    credits: "SARDAR RDX",
    name: "pair7",
    aliases: ["couple7", "firepair"],
    description: "Fire ring pair image banao (Style 7).",
    usage: "pair7 [@mention / reply]",
    category: "Love",
    prefix: true,
    cooldowns: 5
  },
...
` +
    ...
    const { msgID: loadMsgID, done: animDone } = await animateProgress(api, threadID, messageID, '🔥', '𝐅𝐢𝐫𝐞 𝐏𝐚𝐢𝐫', 'pair7');
